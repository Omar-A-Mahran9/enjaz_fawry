...
<div class="m-portlet m-portlet--mobile">
        ...
        <div class="m-portlet__head-tools">
            <ul class="m-portlet__nav">
                <li class="m-portlet__nav-item">
                        <a href="{{ route('dashboard.accounts.withdraw.archive') }}" class="btn btn-primary m-btn m-btn--pill m-btn--custom m-btn--icon m-btn--air">
                        <span>
                            <i class="la la-bars"></i>
                            <span>ارشيف الطلبات</span>
                        </span>
                    </a>
                </li>
    ...
    <div class="m-portlet__body">
        ...
        <p style="text-align:center"> لا يوجد طلبات سحب ارصدة جديدة</p>

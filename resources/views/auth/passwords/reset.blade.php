        ...
        <div class="col-md-8">
            ...
            <div class="card" style="background-color: #F2EFEA;">
                ...
                <div class="card-body">
                    ...
                    <P class="text-right">
                        ادخل البريد الالكتروني وكلمة المرور الجديدة                    
                    </p>
                    ...
                    <form class="engaz-form" style="width:100%!important;" action="{{ route('password.update', ['token' =>$token]) }}" method="POST">
                        ...
                        <div class="form-group row mb-0">
                            ...
                            {{-- <button  class="btn engaz-btn transform">تأكيد</button> --}}
                                <input type="submit" class="engaz-btn transform" value="اعادة التعيين">
                            </div>
                        </div>
                    </form>

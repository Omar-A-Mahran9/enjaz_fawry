...
class OrderTa3medController extends Controller
{
    ...
    public function ta3medShow(Request $r)
    {
    ...
    public function ta3med_payment_callback(Request $r){
    ...
    public function printInvoice(Request $r)
    {
        ...
        if( in_array($id, $orders) ){
            ...
            $view = view('engazFawry.dashboard.printInvoice_ta3med', compact('order','tPrice', 'mobile'));
    ...
    public function ReviewTa3med(Request $r)
    {
          $r->validate([

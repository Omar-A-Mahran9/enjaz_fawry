...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="m-portlet m-portlet--tab">
            ...
            <!--begin::Form-->
            <form method="POST" action="{{ route('dashboard.custom_fields.store') }}" class="m-form m-form--fit m-form--label-align-right" enctype="multipart/form-data">
                @csrf
                <div class="m-portlet__body">
                    <div class="form-group m-form__group row">
                        <label class="col-lg-2 col-form-label">الوصف</label>
                        <div class="col-lg-6">
                            <textarea name="title" id="" cols="30" rows="2" class="form-control m-input m-input--solid">{{ old('title') }}</textarea>
                        </div>
                    </div>

    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="m-portlet m-portlet--tab">
                ...
                <!--begin::Form-->
                <form method="POST" action="{{ route('dashboard.users.client_update', ['id' =>$user->id]) }}" class="m-form m-form--fit m-form--label-align-right">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="form-group m-form__group row">
                            ...
                            <div class="col-lg-6">
                                <select name="type" class="form-control m-input m-input--solid">
                                    <option value="individual" @if($user->type == "individual" ) selected="selected" @endif >عميل</option>

...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active" aria-current="page">طلبات قيد التنفيذ</li>
    </ol>
  </nav>

  <div class="sepTabs row">
    <div class="col-md-4">
      <a href="{{ route('my.orders.new')}}">الطلبات الجديدة</a>
    </div>
    <div class="col-md-4">
      <a href="{{ route('my.orders.onprocess')}}"  class="active">طلبات قيد التنفيذ</a>
    </div>
    <div class="col-md-4">
...
<div class="table-responsive-sm">
  ...
  @else  
    <div class="text-right">
      لا توجد طلبات قيد التنفيذ بحسابك
    </div>

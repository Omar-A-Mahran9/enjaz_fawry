...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active" aria-current="page">الطلبات المنتهية</li>
    </ol>
  </nav>
  ...
  <div class="sepTabs row">
    ...
    <div class="col-md-4">
      <a href="{{ route('my.orders.finished')}}" class="active"> الطلبات المنتهية</a>
    </div>
  </div> {{-- sepTabs --}}

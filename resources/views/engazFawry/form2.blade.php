...
@section('title')إضافة طلب تعميد   - إنجاز فوري@endsection

@section('seo')
<meta name="title" content="إضافة طلب تعميد - إنجاز فوري">
<meta name="description" content="أضف طلب التعميد التي ترغب في إنجازها عبر منصة إنجاز فوري (منصة متخصصه في التعقيب وإنجاز جميع الخدمات الحكومية وتراخيص الأنشطة التجاريه خبره 25 عاما) 0566661105">
@endsection
@section('content')
<section class="light">
  <div class="container">
      ...
      <form class="engaz-form signup-form text-right light" id="form" action="{{ route('ta3med_send') }}" method="POST" enctype="multipart/form-data">
          ...
          <div class="row">
            <div class="col-12 col-md-4">
              ...
              <input required="" type="tel" class="form-control transform" id="phone_client" name="phone_client" value="{{ old('phone_client')}}"  placeholder="مثال : 055xxxxxxx">
              </div>
            </div>
            <div class="col-12 col-md-4">
              <div class="form-group">
                <label for="phone_mo3akeb"> جوال المعقب<span>*</span></label>
                <input required="" type="tel" class="form-control transform" id="phone_mo3akeb" name="phone_mo3akeb" value="{{ old('phone_mo3akeb')}}"  placeholder="مثال : 055xxxxxxx">
              </div>
            </div>
            <div class="col-12 col-md-4">
              <div class="form-group">
    ...
    /*   $(document).ready(function(){
          ...
          $('#uploadFile').on('change', function() {
            ...
            if (size > 2000000 ) {
                ...
                console.log('error');
                $(this).parent('form#form').attr('onsubmit','return false;');
                //$('#form').

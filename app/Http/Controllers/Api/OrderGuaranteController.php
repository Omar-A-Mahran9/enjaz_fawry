...
class OrderGuaranteController extends Controller
{
    ...
    public function guaranteShow(Request $r)
    {
    ...
    public function guarante_payment_callback(Request $r){
    ...
    public function printInvoice(Request $r)
    {
        ...
        if( in_array($id, $orders) ){
            ...
            $view = view('engazFawry.dashboard.printInvoice_guarante', compact('order','tPrice', 'mobile'));
    ...
    public function ReviewGuarante(Request $r)
    {
        $r->validate([
